...
Don't forget to take into account there might be a draw (the same
average score)

4. EXTRA: Mary aslo plays basketball, and her team scored 97, 134
and 105 points. Like before, log the average winner to the console.
HINT: You will need the && operator to take the decision.
If yoi can't solve this one, just watch the solution, it's no problem
:)
